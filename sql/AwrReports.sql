...
PRO <tr><th>Report</th><th>Start Time</th><th>Duration</th><th>SQL Elapsed Time (s)</th></tr>
...
SET MARK HTML OFF;
PRO <h2>Comments</h2>
PRO <p>Displays last 3 days of AWR Reports</p>
PRO <p><b>Duration</b> is the elapsed time between the begin snap and end snap</p>
