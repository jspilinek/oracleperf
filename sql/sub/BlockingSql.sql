...
l2.ctime as seconds, s2.wait_class, l2.type as lock_type, sqla1.SQL_FULLTEXT as Blocker_SQL, sqla2.SQL_FULLTEXT as Waiter_SQL, 
s1.program as blocker_program, s1.wait_class as blocker_wait, s1.event as blocker_event,
sqla3.SQL_FULLTEXT as blocker_prev_SQL
