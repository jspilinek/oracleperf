--query based on http://www.databasejournal.com/features/oracle/article.php/3807976/Modeling-Oracle-Time.htm
...
select decode(stat_name,'hard parse elapsed time',30) id ,
       decode(stat_name,'hard parse elapsed time',22) pid , stat_name, value
  from v$sys_time_model
...
select decode(stat_name,'failed parse elapsed time',31) id ,
       decode(stat_name,'failed parse elapsed time',22) pid , stat_name, value
  from v$sys_time_model
...
select decode(stat_name,'connection management call elapsed time',23) id ,
...
select decode(stat_name,'sequence load elapsed time',24) id ,
